...
from graphgps.encoder.voc_superpixels_encoder import VOCNodeEncoder, VOCMaskedNodeEncoder, COCONodeEncoder
...
ds_encs = {'Atom': AtomEncoder,
           ...
           'VOCMaskedNode': VOCMaskedNodeEncoder,
           'COCOMaskedNode': COCONodeEncoder,
