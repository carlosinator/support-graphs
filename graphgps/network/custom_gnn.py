...
from graphgps.encoder.extended_encoder import ExtendedFeatureEncoder
...
class CustomGNN(torch.nn.Module):
    ...
    def __init__(self, dim_in, dim_out):
        super().__init__()
        self.encoder = ExtendedFeatureEncoder(dim_in)
        ...
        assert cfg.gnn.dim_inner == dim_in or cfg.gnn.layers_pre_mp == 0, \
